...
7. If you need to reset the administrator password:
   - Go to AWS Systems Manager > State Manager
   - Find the association with `Document name` that is called `wireguard-reset-password`
   - Select the association and click `Apply association now`
   - After the command completes successfully, refresh your VPN management dashboard page
